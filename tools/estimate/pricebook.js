...
const DEFAULT_PRICEBOOK = {
  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        { name: '標準取付工事', spec: '〜4.0kW（6〜14畳）', unit: '台', price: 16000, color: '緑' },
        { name: '標準取付工事', spec: '4.0〜6.3kW（14〜20畳）', unit: '台', price: 22000, color: '緑' },
        { name: '標準取付工事', spec: '6.3kW超（20畳以上・単相200V）', unit: '台', price: 28000, color: '緑' },
        { name: '既存機 取外し', spec: '', unit: '台', price: 8000, color: '灰' },
        { name: '入替工事（取外し＋取付 同日）', spec: '', unit: '台', price: 24000, color: '緑' },
        { name: '配管延長', spec: '標準4mを超える分', unit: 'm', price: 3000, color: '水' },
        { name: '配管化粧カバー（屋外）', spec: '', unit: 'm', price: 3000, color: '水' },
        { name: '配管化粧カバー（屋内）', spec: '', unit: 'm', price: 4000, color: '水' },
        { name: '化粧カバー 曲がり・ジョイント', spec: '', unit: '箇所', price: 1500, color: '水' },
        { name: '電圧切替（100V ⇔ 200V）', spec: '', unit: '式', price: 5000, color: '桃' },
        { name: '専用コンセント新設', spec: '分電盤からの配線含む', unit: '式', price: 16000, color: '桃' },
        { name: 'コンセント交換（形状変更）', spec: '', unit: '箇所', price: 4000, color: '桃' },
        { name: '壁貫通穴あけ（木造・モルタル）', spec: '', unit: '箇所', price: 5000, color: '茶' },
        { name: '壁貫通穴あけ（ALC・コンクリート）', spec: '', unit: '箇所', price: 12000, color: '茶' },
        { name: '室外機 立ち下ろし（1階置き）', spec: '', unit: '台', price: 5000, color: '紫' },
        { name: '室外機 壁面金具設置', spec: '', unit: '台', price: 12000, color: '紫' },
        { name: '室外機 屋根置き設置', spec: '', unit: '台', price: 15000, color: '紫' },
        { name: '室外機 二段置き金具', spec: '', unit: '台', price: 14000, color: '紫' },
        { name: '室外機 天吊り金具', spec: '', unit: '台', price: 18000, color: '紫' },
        { name: '高所作業（2階以上・脚立不可）', spec: '', unit: '式', price: 10000, color: '紫' },
        { name: '真空引き・ガスチャージ追加', spec: '', unit: '式', price: 6000 },
        { name: 'ドレンポンプ設置', spec: '', unit: '台', price: 18000, color: '水' },
        { name: '防振ゴム・据付ブロック', spec: '', unit: '台', price: 3000, color: '紫' },
    ...
    },
    {
      ...
      items: [
        ...
        /* 昇降パネル。高い天井のフィルター清掃のために入れることが多い。
           天カセにも天吊形にも付くので、規格は決め打ちにしない。
           本体は機器側の別売部品なので、ここは取付と配線・設定の手間ぶん。 */
        { name: 'オートグリル 組み込み', spec: '', unit: '台', price: 20000, color: '青' },
        ...
        { name: '冷媒配管 新設', spec: '被覆銅管・保温込み', unit: 'm', price: 6000, color: '水' },
        { name: '冷媒配管 既設流用（洗浄・フラッシング）', spec: '', unit: '式', price: 25000, color: '水' },
        { name: 'ドレン配管 新設', spec: '', unit: 'm', price: 3000, color: '水' },
        { name: 'ドレンアップポンプ', spec: '', unit: '台', price: 25000, color: '水' },
        { name: '配管化粧カバー（屋外）', spec: '', unit: 'm', price: 4000, color: '水' },
        { name: '電源工事（単相200V）', spec: 'ブレーカー増設含む', unit: '式', price: 30000, color: '桃' },
        { name: '電源工事（三相200V）', spec: 'ブレーカー増設含む', unit: '式', price: 45000, color: '桃' },
        { name: '点検口 新設', spec: '450角', unit: '箇所', price: 15000, color: '茶' },
        { name: '天井開口・復旧', spec: '', unit: '箇所', price: 20000, color: '茶' },
        { name: '下地補強（吊ボルト・アンカー）', spec: '', unit: '台', price: 12000, color: '茶' },
        { name: '高所作業車 使用', spec: '', unit: '日', price: 40000, color: '紫' },
        { name: 'ユニック・クレーン 使用', spec: '', unit: '日', price: 50000, color: '紫' },
        { name: '足場設置・解体', spec: '', unit: '式', price: 60000, color: '紫' },
    ...
    },
    {
      ...
      work: true,          // ここから入れた行は「作業費」として数える（消耗品雑費の計算のもと）
      items: [
        { name: '家庭用 取外しのみ', spec: '', unit: '台', price: 8000, color: '灰' },
        { name: '家庭用 移設（同一建物内）', spec: '取外し＋再取付', unit: '台', price: 30000, color: '緑' },
        { name: '家庭用 移設（別建物・運搬含む）', spec: '', unit: '台', price: 38000, color: '緑' },
        { name: '業務用 取外しのみ', spec: '天カセ・パッケージ', unit: '台', price: 40000, color: '灰' },
        { name: '業務用 移設', spec: '取外し＋再取付', unit: '台', price: 120000, color: '緑' },
        { name: '家電リサイクル料（エアコン）', spec: '', unit: '台', price: 2000, color: '灰' },
        { name: '収集運搬料', spec: '', unit: '台', price: 3000, color: '灰' },
        { name: '業務用 廃棄処分', spec: 'フロン回収含む', unit: '台', price: 25000, color: '灰' },
        { name: 'フロン回収・行程管理票発行', spec: '', unit: '台', price: 8000, color: '灰' },
        { name: '残置配管 撤去', spec: '', unit: '式', price: 8000, color: '灰' },
        { name: '壁穴 補修（パテ・キャップ）', spec: '', unit: '箇所', price: 3000, color: '茶' },
        { name: '壁穴 補修（造作・下地復旧）', spec: '', unit: '箇所', price: 12000, color: '茶' }
      ]
    },
